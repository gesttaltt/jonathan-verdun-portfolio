...
export const en: Translations = {
  ...
  sections: {
    ...
    contactForm: {
      ...
      successMessage: 'Thanks for reaching out. I will get back to you within 48 hours.',
      errorTitle: 'Something went wrong',
      errorMessage: 'Could not send your message. Please try again or email me directly.',
      validationRequired: 'This field is required',
      validationEmail: 'Please enter a valid email address',
      formDisabled: 'Contact form is not configured. Please email me directly.',
    },
  },
  visualTestSummary: {
