        ...
        <div className="light:border-border-subtle flex flex-col justify-between gap-4 border-b border-white/10 pb-6 sm:flex-row sm:items-end">
          ...
          <div className="relative w-full max-w-sm">
            ...
            <input
              ...
              className="light:border-border-subtle light:bg-white text-text-primary light:focus:border-amber-600 w-full rounded-lg border border-white/10 bg-white/5 py-2 pr-10 pl-10 text-sm transition-colors focus:border-amber-500/50 focus:bg-white/10 focus:outline-none"
            />
            {searchQuery && (
              <button
