          ...
          <div className="group bg-bg-card hover:bg-bg-card-hover light:border-border-subtle light:hover:border-amber-400/50 light:hover:shadow-xl light:hover:shadow-amber-500/5 relative overflow-hidden rounded-2xl border border-white/10 p-5 backdrop-blur-md transition-all sm:p-8">
            ...
            <div className="relative space-y-4">
              ...
              <button
                ...
                aria-label={
                  copied ? t.sections.sidebar.copiedLabel : t.sections.sidebar.copyEmailLabel
                }
              ...
              {/* Visually hidden live region: the visible "Copied!" swap above
                  is purely presentational to a screen reader (AnimatePresence
                  content isn't reliably announced), and the button's own
                  aria-label only updates for a user who re-queries it — this
                  guarantees the confirmation is actually announced. */}
              <span aria-live="polite" className="sr-only">
                {copied ? t.sections.sidebar.copiedLabel : ''}
              </span>
            </div>
          </div>
        </FadeInSection>
